...
export const Qualities = () => {
    ...
    return <section className={`${s.container} ${s.bgImage} pt-20 md:pt-24 pb-20 !bg-cover`}>
        <div className={`${s.gridRow} !place-items-start w-full`}>
            ...
            <p className="font-extralight text-base max-w-[37.5rem]">Choose HeavyTech  for all your MRO needs, and experience the highest level of expertise, quality, and customer service in the industry.</p>
        </div>
    </section>
}