...
export const Certificate = () => {
    return <section className="grid place-items-center w-full">
        <div className={`${s.gridRow} w-full`}>
            <div className={`${s.container} py-28`}>
                <h2 className="max-w-[68.875rem] font-light text-4xl md:text-center">Choose Heavyetch for MRO services that are backed by our commitment to quality, safety, and excellence.</h2>
            </div>
            <div className={`${s.bgImage} bg-[url('./images/bg_certificates_planet_mob.png')] md:bg-[url('./images/bg_certificates_planet.png')] !bg-cover !bg-top h-auto md:h-[23.625rem] w-full md:px-50 py-[4.325rem] flex items-center md:items-start justify-center md:justify-between flex-col md:flex-row gap-10 md:gap-0`}>
