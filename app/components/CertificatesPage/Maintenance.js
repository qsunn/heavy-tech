...
export const Maintenance = () => {
    return <section className={`${s.container} pt-36 pb-20 md:pt-[14rem] relative ${s.bgImage} !bg-cover !bg-bottom bg-[url('./images/bg_certificates_plane_mob.png')] md:bg-[url('./images/bg_certificates_plane.png')]`}>
        ...
        <div>
            ...
            <div className="h-[14.375rem] w-auto bg-[url('./images/logo_big.svg')] bg-center bg-contain bg-no-repeat md:mt-[21.5rem] md:mb-[16.5rem]" />
